...
<html>
    <head>
        ...
        <jsp:useBean class="edu.mou.rps.model.Departments" id="department_" scope="session">
                ...
                <div class="wrap">
                    <div class="left-nav">
                        <ul>
                            ...
                            <li ><a href=#>View Department's Result Sheet</a></li>
                            <!--<li><a href="dep_generate.jsp">Generate Department Result Sheet</a></li>-->
                            <li class="active"><a href="#">Result Summary Slide</a></li>
                        ...
                        <div class="section group example">
                            <div class="col_1_of_1 span_1_of_1">
                                <div class="form-field">
                                    ...
                                    <form action="/ResultPresentationSystem/GetSlides" method="POST">
                                        ...
                                        <div class="input-catch">
                                            ...
                                            <div class="label2">
                                                ...
                                                <c:forEach var="deptProgram" items="${program.departmentPrograms}">
                                                    ...
                                                    <input type="hidden" name="department" value="${department_.departmentName}" >
                                    ...
                                    <div class="input-catch">
                                        ...
                                        <div class="label2">
                                            ...
                                            <button type="submit" class="btn"> GET SLIDES</button>
                                        </div>
                                    </div>
