                ...
                <div class="wrap">
                    <div class="left-nav">
                        <ul>
                            ...
                            <li class="active"><a href="deanslidespage.jsp">Faculty Result Slides</a></li>
                        ...
                        <div class="section group example">
                            <div class="col_1_of_1 span_1_of_1">
                                <div class="form-field">
                                    ...
                                    <form action="/ResultPresentationSystem/GetSlides">
                                        <div class="input-catch">
                                            ...
                                            <div class="label2" >
                                                ...
                                                <c:forEach var="dept" items="${department.departments}" >
                                                    <c:if test="${dept != null}">
                                                        <option>${dept}</option>
                                                    </c:if>
