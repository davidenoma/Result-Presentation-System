        ...
        <body>
            ...
            <div class="header-nav">
                <div class="wrap">
                    <div class="left-nav">
                        <ul>
                            <li class="active"><a href="hods_dashboard.jsp">Back To Home</a></li>


                            <!--<li><a href="hodsresultsheet.jsp">Back to Faculty Result Sheet</a></li>-->
                    ...
                    <div class="singlelink">
                        <div class="section group example">
                            <div class="col_1_of_1 span_1_of_1">
                                ...
                                %>
                                <h1 style="text-align:center;font-size: 18px" id="title">RESULTS FOR ${program.programName}, ${course.level} LEVEL </h1><BR>
