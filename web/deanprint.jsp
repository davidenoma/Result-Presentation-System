        ...
        <body>
                ...
                <div class="wrap">
                    ...
                    <div class="top-search-bar">
                        <div class="header-top-nav">
                            <ul>
                                <li><a href="dean.jsp"><img src="images/marker1.png" title="customer report" />LOGOUT</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="clear"> </div>
            ...
            <div class="header-nav">
                <div class="wrap">
                    <div class="left-nav">
                        <ul>
                            <li ><a href="dean_dashboard.jsp">Home</a></li>
                            <li class="active"><a href="deanresultsheet.jsp">Faculty Result sheet</a></li>
                            <li><a href="dean_summary.jsp">Faculty Result Slides</a></li>
                        ...
                        <div class="section group example">
                            <div class="col_1_of_1 span_1_of_1">
                                <div class="form-field">
                                    ...
                                    <form action="/ResultPresentationSystem/GetDeanResults">
                                    ...
                                    <div class="input-catch">
                                        ...
                                        <div class="label2">
                                            <select class="input" name="program">
                                                <c:forEach var="program" items="${programs.allPrograms}">
